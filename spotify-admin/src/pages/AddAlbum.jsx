...
const AddAlbum = () => {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            toast.error("An error occurred while adding the album. Please try again.");
        }
  ...
  return loading ? (
    ...
    <form onSubmit={onSubmitHandler} className='flex flex-col items-start gap-8 text-gray-600'>
        ...
        <div className='flex flex-col gap-2.5'>
            ...
            <input onChange={(e) => setDesc(e.target.value)} value={desc} className='b-transparent outline-green-600 border-2 border-gray-400 p-2.5 w-180' placeholder='Type here...' type="text" required />
        </div>
